...
int main(int argc, char **argv) {
	...
	/* 坐标X,Y,速度VX,VY,半径。质量。。*/
	gameObjects.push_back(new Square(250, 50, 0, 50, 100, 100));
	gameObjects.push_back(new Square(370, 0, 0, -50, 50, 50));
	gameObjects.push_back(new Square(150, 30, 50, 50, 75, 75));
	gameObjects.push_back(new Square(350, 75, -50, 50, 65, 65));
	gameObjects.push_back(new Square(300, 300, 50, -50, 80, 80));
	gameObjects.push_back(new Square(400, 300, 50, -50, 125, 120));
gameObjects.push_back(new Square(400, 430, 50, -50, 95, 95));
	bool quit = false;
	SDL_Event e;
